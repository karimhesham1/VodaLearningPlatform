...
class PostServiceTest {
    ...
    void testCreatePost_SuccessfulPostCreation(){
        ...
        List<com.vodafone.learningHub.openapi.model.Tag> tag = new ArrayList<>();

        com.vodafone.learningHub.openapi.model.Tag newTag = new com.vodafone.learningHub.openapi.model.Tag();
